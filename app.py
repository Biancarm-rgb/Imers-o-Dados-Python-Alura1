...
# Colunas do começo do Dashboard
...
with col_graf3:
    if not df_filtrado.empty:
        ...
        grafico_remoto = px.pie(
            ...
            hole=0.5 # usamos esse hole para que o gráfico em formato de pizza fico com o formato de um disco, o número determina o tamanho do disco.
        )
